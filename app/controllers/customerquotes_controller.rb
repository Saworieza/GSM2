class CustomerquotesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @customerquote.save
        format.html { redirect_to root_path, notice: 'Customerquote was successfully created.' }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to root_path, notice: 'Customerquote was successfully destroyed.' }
  ...
  private
    ...
    def customerquote_params
      params.require(:customerquote).permit(:name, :date, :amount, :costcenter_id)
    end
end
