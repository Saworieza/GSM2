...
class InvoicesTest < ApplicationSystemTestCase
  ...
  test "creating a Invoice" do
    ...
    fill_in "Customerpo", with: @invoice.customerpo_id
    fill_in "Date", with: @invoice.date
    fill_in "Number", with: @invoice.number
    fill_in "Scope", with: @invoice.scope_id
    fill_in "Site", with: @invoice.site_id
    fill_in "Status", with: @invoice.status_id
