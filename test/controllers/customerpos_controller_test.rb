...
class CustomerposControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create customerpo" do
    assert_difference('Customerpo.count') do
      post customerpos_url, params: { customerpo: { amount: @customerpo.amount, customerquote_id: @customerpo.customerquote_id, date: @customerpo.date, number: @customerpo.number, scope_id: @customerpo.scope_id } }
    end
  ...
  test "should update customerpo" do
    patch customerpo_url(@customerpo), params: { customerpo: { amount: @customerpo.amount, customerquote_id: @customerpo.customerquote_id, date: @customerpo.date, number: @customerpo.number, scope_id: @customerpo.scope_id } }
