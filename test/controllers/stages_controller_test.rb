...
class StagesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create stage" do
    assert_difference('Stage.count') do
      post stages_url, params: { stage: { milestone_id: @stage.milestone_id, percentage: @stage.percentage } }
    end
  ...
  test "should update stage" do
    patch stage_url(@stage), params: { stage: { milestone_id: @stage.milestone_id, percentage: @stage.percentage } }
