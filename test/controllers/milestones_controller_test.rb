...
class MilestonesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create milestone" do
    assert_difference('Milestone.count') do
      post milestones_url, params: { milestone: { milestone_type: @milestone.milestone_type } }
    end
  ...
  test "should update milestone" do
    patch milestone_url(@milestone), params: { milestone: { milestone_type: @milestone.milestone_type } }
